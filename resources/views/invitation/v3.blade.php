...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* === SECTION 5: CLOSING - FULLSCREEN WITH VIDEO BACKGROUND === */
        .section-closing {
            flex-direction: column;
            text-align: center;
            gap: 25px;
...
<body>
    ...
    <div class="scroll-container" id="scrollContainer">
        ...
        <div class="fullscreen-section section-photos fade-section" data-index="2">
            <video class="section-photos-video" autoplay muted loop playsinline preload="none" data-lazy-video>
        ...
        {{-- SECTION 4: DETAILS & RSVP --}}
        <div class="fullscreen-section section-details-rsvp fade-section" data-index="3">
            <video class="section-details-rsvp-video" autoplay muted loop playsinline preload="none" data-lazy-video>
                <source data-src="{{ asset('assets/img/section-purple.mp4') }}" type="video/mp4">
            </video>
            <div class="details-rsvp-content">
                ...
                <div class="details-list">
                    ...
                    <div class="detail-item">
                        ...
                        <p class="detail-time-inline">{{ $guest->event->event_time ?? 'To be announced' }}</p>
                    </div>
        ...
        {{-- SECTION 5: CLOSING --}}
        <div class="fullscreen-section section-closing fade-section" data-index="4">
